/*   STEP 1   */
export const leagueID = "857554534694797312"; // your league ID
...
export const homepageText = `
  <p>I'm using this as a test to see what kind of stats we can get ouside of Sleeper.  Let me know your thoughts.</p>
`;
...
export const managers = [
   {
     ...
     "location": "Silver Spring, MD", // (optional)
     "bio": "Fantasy Baller",
   ...
   },
   {
     ...
     "name": "DB",
     "tookOver": 2017, // (optional) used if a manager took over a team, delete this line or change to null otherwise
     "location": "Fort Mill, SC", // (optional)
     "bio": "Fantasy Baller",
     "photo": "/managers/name.jpg", // square ratio recommended (no larger than 500x500)
     "fantasyStart": 2005, // (optional) when did the manager start playing fantasy football
     "favoriteTeam": "clt", // (optional) favorite NFL team, (follows convention: nyj, sea, mia, etc.) MUST BE LOWERCASE
     "mode": "Win Now", // (optional) 'Win Now', 'Dynasty', or 'Rebuild' (anything else and you will need to add a new png to /static/ similar to the 'Rebuild.png' and 'Win Now.png' currently in there)
     "rival": {
   ...
   },
   {
     ...
     "name": "Catfish",
     "tookOver": 2017, // (optional) used if a manager took over a team, delete this line or change to null otherwise
     "location": "Cartersville, GA", // (optional)
     "bio": "Fantasy Baller",
     "photo": "/managers/name.jpg", // square ratio recommended (no larger than 500x500)
     "fantasyStart": 2005, // (optional) when did the manager start playing fantasy football
     ...
     "rival": {
       name: "Crabby", // Can be anything (usually your rival's name)
   ...
   },  
   {
     ...
     "mode": "Win Now", // (optional) 'Win Now', 'Dynasty', or 'Rebuild' (anything else and you will need to add a new png to /static/ similar to the 'Rebuild.png' and 'Win Now.png' currently in there)
     "rival": {
       name: "DB", // Can be anything (usually your rival's name)
